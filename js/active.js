		...
		if (response.o.f_lf) {
			...
			var sub = -1;
				console.log(url);
					...
					if ((sub = url.indexOf("facebook.com")) && (url.substring(25).length == 0 || url.substring(17).length == 0 || url.substring(sub).indexOf("home.php") != -1 || url.substring(sub).indexOf("?rel=") != -1)) {
